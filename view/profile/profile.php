                                    ...
                                    <div class="flex flex-1 flex-col mr-10 2xl:mr-22-5">
                                        <div class="w-full flex flex-row">
                                            ...
                                            <div class="flex flex-1 flex-col">
                                                <input placeholder="Chưa có thông tin" maxlength="55" class="w-full outline-0 h-10 border-0 bg-white-241 px-4-5 rounded-full placeholder-black-153 text-black-222 text-sm-15-24"> <!---->
                                            </div>
                                        </div> 
                                        <div class="w-full mt-3 flex flex-row">
                                            ...
                                            <div class="flex flex-1 flex-col">
                                                <input placeholder="<?php echo $user->email; ?>" class="w-full outline-0 h-10 border-0 bg-white-241 px-4-5 rounded-full placeholder-black-153 text-black-222 text-sm-15-24"> <!---->
                                            </div>
                                        </div> 
                                        <div class="w-full mt-3 flex flex-row">
                                            <div class="w-35 flex-row-center h-10">
