<footer class="body border border-success border-end-0 border-bottom-0 border-start-0 border-5" style="padding: 2em 3em;">
    <div class="row .text-secondary-emphasis">
        ...
        <div class="col-2">
            <div class="footer-right footer-social-contact mt-5">
                <div class="title fw-bold text-center">Liên hệ</div>
                <div class="content">
