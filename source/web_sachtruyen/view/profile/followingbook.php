                ...
                <div class="ml-10 2xl:ml-14 flex flex-1 flex-col">
                    <div user-info="[object Object]" class="w-full">
                        <div class="w-full flex flex-row pb-3 border-b border-black-6">
                            <a href="http://127.0.0.1/web_sachtruyen/view/profile/bookcase.php" aria-current="page"  class="w-max mr-7-5 flex flex-col items-center text-black-153">
                                <h3 class="text-2xl-24-30 font-medium">Đã sở hữu</h3> 
                                <div class="w-4-5 mt-1-5 h-1-5 rounded-full bg-transparent"></div>
                                
                            </a>
                            <a href="http://127.0.0.1/web_sachtruyen/view/profile/followingbook.php" class="w-max mr-7-5 flex flex-col items-center nuxt-link-exact-active nuxt-link-active text-cdv">
                        ...
                        <?php
                        $listBooks = BookCase::getListBooks($_SESSION['id']);
