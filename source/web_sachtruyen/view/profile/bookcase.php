                            ...
                            <div class="w-full flex flex-row flex-wrap">
                                <div class="nth-2th-mr-7-5 pt-5">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT SachID FROM muasach WHERE NguoiDungID = '$user->id'";
                                        $list = $db->query($sql);
                                        foreach ($list as $s) { 
                                            $q = Sach::findById($s);
                                            echo '<div class="flex flex-1 flex-col h-full pt-3"><a href="/storybook/detail/ao-cuoi-thien-duong-nv279" class="text-sm-15-18 text-black-222 hover:text-cdv">Áo cưới Thiên Đường</a> 
                                            <div class="w-full mt-2-25">
                                                <div class="flex flex-row items-center">
                        
                                                    <div class="flex flex-1">
                                                        <a href="'.$q->URLbiaSach.'" class="text-sm-14-16 text-cdv font-bold fm-t-ellipsis-1">87</a>
                                                    </div>
                                                </div> 
